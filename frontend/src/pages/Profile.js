	...
	return(
		<>	
			...
			<div className="containerButtonCheck">
				<button styles={styles.buttonCheck} onClick={() => selectComponent("data")}>Datos</button>
				<button styles={styles.buttonCheck} onClick={() => selectComponent("fav")}>Favoritos</button>
				<button styles={styles.buttonCheck} onClick={() => selectComponent("his")}>Historial</button>	
			</div>
