      ...
      <div className={styles.containerFooter}>
        ...
        <div className={styles.information}>
          <div className={styles.boxData}>
            <FaMapMarkerAlt style={{ color: 'tomato', fontSize: '1rem', marginRight: '2%' }} />
            <p className={styles.street}>Av. Alicia Moreau de Justo 1930</p>
          </div>
          <div className={styles.boxData}>
            <MdEmail style={{ color: 'tomato', fontSize: '1rem', marginRight: '2%' }} />
            <p>quicky@gmail.com</p>
          </div>
          <div className={styles.boxData}>
            <AiFillPhone style={{ color: 'tomato', fontSize: '1rem', marginRight: '2%' }} />
            <p>011 2496-6463</p>
          </div>
        </div>
