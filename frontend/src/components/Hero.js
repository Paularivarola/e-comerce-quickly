        ...
        <>
            <div className={styles.heroContainer}>
                <div className={styles.boxCall}>
                    <h1 className={styles.heroH1}>Con <span className={styles.spanRed}>Quickly,</span> tenés <span className={styles.spanGrey}>todo.</span></h1>
            ...
            <div>
                <div className={styles.titleBanner}>
                    ...
                    <p className={styles.title2}>¡Vos a lo tuyo y lo demás <span className={styles.span1}>dejáselo a</span> <span className={styles.span2}>Quickly!</span></p>
                </div>
