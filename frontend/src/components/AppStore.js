        ...
        <div className={styles.mainApp}>
            <div className={styles.descriptionBox}>
                <div className={styles.titleBox}>
                    <h3 className={styles.title}>Descargate Quickly App</h3>
                    <p className={styles.text}>Ahora podés realizar tus pedidos por la app, nosotros lo preparamos y te lo llevamos a tu mesa. Además vas a tener todas nuestros promos al alcance de tu mano. Con Quickly App comé fácil, rápido y rico!</p>
                </div>
            ...
            <img className={styles.picturePhone} src='https://i.postimg.cc/rskxhyrL/appMoto.png' alt='phone' />
        </div>
    )
}
